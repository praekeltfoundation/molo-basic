...
from molo.basic.decorators import prometheus_query_count
...
def get_pages(context, queryset, locale):
    from molo.basic.models import get_translation_for
...
def render_translations(context, page):
    from molo.basic.models import TranslatablePageMixinNotRoutable
