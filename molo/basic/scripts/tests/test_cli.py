...
class TestCli(TestCase):
    ...
    @patch('molo.basic.cookiecutter.cookiecutter')
    def test_scaffold(self, mock_cookiecutter):
        from molo.basic.scripts import cli
        package = pkg_resources.get_distribution('molo.basic')
    ...
    @patch('molo.basic.scripts.cli.get_package')
    @patch('molo.basic.scripts.cli.get_template_dirs')
    ...
    def test_unpack(self, mock_copytree, mock_get_template_dirs,
        ...
        mock_copytree.assert_called_with(
            pkg_resources.resource_filename('molo.basic', 'templates/foo'),
            pkg_resources.resource_filename('molo.basic', 'templates/foo'))

    def test_get_package(self):
        from molo.basic.scripts.cli import get_package
