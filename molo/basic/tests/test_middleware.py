...
from molo.basic.middleware import MoloGoogleAnalyticsMiddleware
from django.contrib.auth.models import User
from molo.basic.models import Main, Languages, SiteLanguageRelation
...
class TestUtils(TestCase, MoloTestCaseMixin):
    ...
    @responses.activate
    @patch("molo.basic.middleware.build_ga_params")
