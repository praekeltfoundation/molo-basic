...
def create_banner_index(apps, schema_editor):
    from molo.basic.models import BannerIndexPage, Main
...
def create_section_index(apps, schema_editor):
    from molo.basic.models import SectionIndexPage, Main
...
def create_footer_index(apps, schema_editor):
    from molo.basic.models import FooterIndexPage, Main
    main = Main.objects.all().first()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('basic', '0003_configure_root_page')
    ]
