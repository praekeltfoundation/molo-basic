...
MIDDLEWARE = [
    ...
    'molo.basic.middleware.ForceDefaultLanguageMiddleware',
    ...
    'molo.basic.middleware.AdminLocaleMiddleware',
    'molo.basic.middleware.NoScriptGASessionMiddleware',

    'molo.basic.middleware.MoloGoogleAnalyticsMiddleware',
    'molo.basic.middleware.MultiSiteRedirectToHomepage',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'molo.basic.context_processors.locale',
                'molo.basic.processors.compress_settings',
...
CSRF_FAILURE_VIEW = 'molo.basic.views.csrf_failure'
