...
from molo.basic.api import forms, importers
from molo.basic.api.constants import MAIN_IMPORT_FORM_MESSAGES
from molo.basic.api.tests import constants
from molo.basic.api.tests.utils import mocked_requests_get
from molo.basic.models import ArticlePage
from molo.basic.models import SectionPage  # noqa
...
class ArticleImportFormTestCase(MoloTestCaseMixin, TestCase):
    ...
    @patch("molo.basic.api.importers.get_image")
...
class MainImportFormTestCase(MoloTestCaseMixin, TestCase):
    ...
    @patch("molo.basic.api.forms.requests.get",
...
class SectionImportFormTestCase(MoloTestCaseMixin, TestCase):
    ...
    # @patch("molo.basic.api.importers.requests.get",
    #        side_effect=mocked_requests_get)
    # @patch("molo.basic.api.importers.get_image")
