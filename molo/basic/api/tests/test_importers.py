...
from molo.basic.api import importers
from molo.basic.api.errors import (
    RecordOverwriteError,
    ReferenceUnimportedContent,
    ImportedContentInvalid,
)
from molo.basic.api.tests import constants, utils
...
from molo.basic.utils import get_image_hash
...
class TestImageImporter(MoloTestCaseMixin, TestCase):
    ...
    @responses.activate
    @patch("molo.basic.api.importers.ImageImporter.fetch_and_create_image",
